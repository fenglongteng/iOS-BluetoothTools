...
#define kServiceUUID               @"9527" //设备服务的UUID
#define kOutPutcharacteristicUUID  @"1234" //连接的设备特征(通道)输出的UUID
#define kInputCharacteristicUUID   @"1234" //连接的设备特征(通道)输入的UUID
...
- (void)updateDevices:(NSArray *)devices advertisementDatas:(NSMutableArray *)advertisementDatas; //搜索到设备回调
